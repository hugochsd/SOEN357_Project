...
fun Reservation() {//E0E0E0
    ...
    Scaffold { paddingValues ->
        Column(
            ...
            Spacer(modifier = Modifier.height(52.dp))// Space between elements
            ...
            Spacer(modifier = Modifier.height(24.dp))// Space between elements
            Row {
                Text(text = "Competitive match")
                Spacer(modifier = Modifier.width(22.dp))// Space between elements
            ...
            Spacer(modifier = Modifier.height(22.dp))// Space between elements
            ...
            Row() {
                ...
                Spacer(modifier = Modifier.width(72.dp))// Space between elements
                Column {
                    Image(
